    ...
    <div class="container mt-4 mb-5">
        ...
        <form method="POST" action="{{ route('student.update', $student) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="NIS" class="form-control" required placeholder="Masukkan NIS" value="{{ $student->NIS }}">
            </div>
            <div class="mb-3">
                <label class="form-label">Nama Siswa</label>
                <input type="text" name="student_name" class="form-control" required placeholder="Masukkan Nama Siswa" value="{{ $student->student_name }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="place_of_birth" class="form-control" required placeholder="Tempat Lahir" value="{{ $student->place_of_birth }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select name="student_parent_id" class="form-control" required>
                    ...
                    @foreach ($parents as $parent)
                        <option value="{{ $parent->id }}" {{ ($parent->id == $student->student_parent_id) ? 'selected' : '' }}>{{ $parent->parent_name }}</option>
                    @endforeach
                </select>
            </div>
