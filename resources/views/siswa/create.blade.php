...
<form method="POST" action="{{ route('student.store') }}">
    ...
    <div class="row g-3">
        <div class="col-md-6 form-section">
            ...
            <input type="number" id="NIS" name="NIS" class="form-control @error('NIS') is-invalid @enderror" required placeholder="Masukkan NIS" value="{{ old('NIS') }}">
            @error('NIS')
        ...
        <div class="col-md-6 form-section">
            ...
            <input type="text" id="student_name" name="student_name" class="form-control @error('student_name') is-invalid @enderror" required placeholder="Masukkan Nama Siswa" value="{{ old('student_name') }}">
            @error('student_name')
                <div class="invalid-feedback">
                    <i class="bi bi-exclamation-circle me-1"></i>{{ $message }}
                </div>
        ...
        <div class="col-md-6 form-section">
            ...
            <input type="text" id="place_of_birth" name="place_of_birth" class="form-control @error('place_of_birth') is-invalid @enderror" required placeholder="Masukkan Tempat Lahir" value="{{ old('place_of_birth') }}">
        ...
        <div class="col-md-6 form-section">
            ...
            <input type="date" id="date_of_birth" name="date_of_birth" class="form-control @error('date_of_birth') is-invalid @enderror" required  value="{{ old('date_of_birth') }}">
            @error('date_of_birth')
                <div class="invalid-feedback">
                    <i class="bi bi-exclamation-circle me-1"></i>{{ $message }}
                </div>
        ...
        <div class="col-md-6 form-section">
            ...
            <select id="classroom_id" name="classroom_id" class="form-select @error('classroom_id') is-invalid @enderror" required>
                ...
                @foreach ($classrooms as $class)
                    <option value="{{ $class->id }}" {{ old('classroom_id') == $class->id ? 'selected' : '' }}>{{ $class->class_name }}</option>
                @endforeach
            </select>
            @error('classroom_id')
                <div class="invalid-feedback">
        ...
        <div class="col-md-6 form-section">
            ...
            <select id="student_parent_id" name="student_parent_id" class="form-select @error('student_parent_id') is-invalid @enderror" required>
                ...
                @foreach ($parents as $parent)
                    <option value="{{ $parent->id }}" {{ old('student_parent_id') == $parent->id ? 'selected' : '' }}>{{ $parent->parent_name }}</option>
                @endforeach
            </select>
